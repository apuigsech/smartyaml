...
from .parsing import TagParser, ParsedTag
...
class ConstructorRegistry:
    ...
    def dispatch(self, loader: yaml.SafeLoader, tag_suffix: str, node: yaml.Node) -> Any:
        """
    ...
    def _create_constructor_node(self, parsed_tag: ParsedTag, original_node: yaml.Node) -> yaml.Node:
        """
