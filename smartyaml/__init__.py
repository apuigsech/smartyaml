...
def load(stream: Union[str, Path], base_path: Optional[Union[str, Path]] = None, 
         ...
         max_recursion_depth: Optional[int] = None, remove_metadata: bool = True,
    ...
    from .utils.variable_substitution import extract_vars_metadata, VariableSubstitutionEngine
