...
class TagParser:
    ...
    def create_scalar_node(self, tag: str, value: str, start_mark=None) -> yaml.ScalarNode:
    ...
    def create_sequence_node(self, tag: str, parameters: List[str], start_mark=None) -> yaml.SequenceNode:
