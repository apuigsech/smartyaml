...
class ContentReader:
    ...
    def read_from_stream(self, stream: Union[str, Path], base_path: Path = None) -> Tuple[str, Path]:
        """
    ...
    def _read_from_file(self, file_path: Path, base_path: Path = None) -> Tuple[str, Path]:
    ...
    def _read_from_string(self, content: str, base_path: Path = None) -> Tuple[str, Path]:
