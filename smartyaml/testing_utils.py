...
if TYPE_CHECKING:
    from .type_annotations import YAMLValue, ParameterDict
...
class SmartYAMLTestCase:
    ...
    def assert_yaml_equal(self, actual: Any, expected: Any) -> None:
        ...
        """
        assert actual == expected, f"YAML values not equal:\nActual: {actual}\nExpected: {expected}"
    
    def assert_contains_key(self, data: Dict[str, Any], key: str, 
...
class ConstructorTestHelper:
    ...
    @staticmethod
    def create_mock_loader(base_path: Optional[Path] = None,
                          template_path: Optional[Path] = None,
                          max_file_size: int = 1024*1024,
                          max_recursion_depth: int = 10) -> Any:
        """
    ...
    @staticmethod
    def create_mock_node(tag: str = "!test", value: Any = "test_value",
                        start_mark: Optional[Any] = None) -> Any:
        """
    ...
    @staticmethod
    def create_sequence_node(values: List[str], tag: str = "tag:yaml.org,2002:seq") -> Any:
...
class ErrorTestHelper:
    ...
    @staticmethod
    def assert_constructor_error(error: Exception, directive_name: str,
        ...
        if hasattr(error, 'directive_name'):
            assert error.directive_name == directive_name, \
...
class PerformanceTestHelper:
    ...
    @staticmethod
    def assert_performance_threshold(func: callable, max_seconds: float,
                                   *args, **kwargs) -> Any:
        """
