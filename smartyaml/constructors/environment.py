...
from ..utils.validation_utils import validate_constructor_args, validate_environment_variable, get_env_var
...
class EnvironmentConstructor(EnvironmentBasedConstructor):
    ...
    def extract_parameters(self, loader, node) -> Dict[str, Any]:
        ...
        if isinstance(node, yaml.ScalarNode):
            ...
            raise EnvironmentVariableError(f"{self.directive_name} expects a scalar or sequence")
