...
class ErrorContextBuilder:
    ...
    @staticmethod
    def build_constructor_context(directive_name: str, loader, params: Dict[str, Any], 
                                node: Optional[yaml.Node] = None) -> Dict[str, Any]:
        """
        ...
        safe_params = ['filename', 'var_name', 'condition', 'template_name', 'operation']
    ...
    @staticmethod
    def format_context_string(context: Dict[str, Any], 
        ...
        for key, value in context.items():
            ...
            if key in ['line', 'column', 'source']:
                if key == 'line' and 'line' not in [item.split('=')[0] for item in location_info]:
