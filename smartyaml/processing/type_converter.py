...
class TypeConverter:
    ...
    def register_converter(self, type_name: str, converter: Callable[[Any], Any]) -> None:
        """
    ...
    def convert(self, value: Any, target_type: Union[str, type], 
               directive_name: str = "", param_name: str = "") -> Any:
        """
    ...
    def convert_parameters(self, params: Dict[str, Any], 
...
def convert_value(value: Any, target_type: Union[str, type], 
                 directive_name: str = "", param_name: str = "") -> Any:
    """
