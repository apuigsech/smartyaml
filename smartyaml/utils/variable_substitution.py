...
class VariableSubstitutionEngine:
    ...
    def substitute_string(self, text: str) -> str:
        ...
        def replace_variable(match):
            ...
            if var_name not in self.variables:
                raise ValueError(f"Variable '{var_name}' not found in substitution context")
    ...
    def substitute_recursive(self, data: Any) -> Any:
        ...
        if isinstance(data, dict):
            return {
                key: self.substitute_recursive(value)
    ...
    def merge_variables(self, base_vars: Optional[Dict[str, Any]], 
                       override_vars: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        """
