...
def create_loader_context(base_loader, base_path: Path, template_path: Optional[Path] = None, 
                         import_stack: Optional[Set[Path]] = None, max_file_size: Optional[int] = None,
